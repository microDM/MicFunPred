...
class MinPath:
    ...
    def WriteReport(self, minpath, reportfile, detailfile):
        ...
        for p in range(self.pathTot):
            ...
            file.write("path " + str(self.pathList[p]) + "\t" + str(tags[0]) + " " + str(tmp) + "\tnaive " + str(pathvalid[p][1]) + "\tminpath " + str(pathvalid[p][2]) + "\tfam0 " + str(len(self.path2Fam[p])) + "\tfam-found " + str(add) + "\tname " + str(self.pathName[p]) + "\n")
